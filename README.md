...
<p align="center">
  <b>MTech CS @ IIIT Delhi &nbsp;|&nbsp;</b><br/>
  Building systems that are fast, secure, and intelligent.
</p>
...
Built recruiter dashboards, real-time application tracking, and secure one-to-one and group messaging with per-user encryption.
...
<p align="center">
  <i>"Building systems from the ground up — one fork() at a time."</i>
</p>
